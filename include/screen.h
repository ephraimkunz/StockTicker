...
// Write the screen for the stock symbol at the current screen index, if it needs to be updated.
void screen_write_stock_screen_if_needed();

// Handle any touch events by updating the state and screen.
void screen_handle_touch();

// Update the current screen global to be within the bounds of fetched stock information.
